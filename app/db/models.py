...
class SoldMachine(Base):
    ...
    service_reports = relationship("ServiceReport", back_populates="sold_machine")
    def __repr__(self):
        return f"<SoldMachine {self.serial_no}>"
...
class ServiceReport(Base):
    ...
    sold_machine_id = Column(UUID(as_uuid=True), ForeignKey("sold_machines.id"))
    ...
    sold_machine = relationship("SoldMachine", back_populates="service_reports")
