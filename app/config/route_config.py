...
MACHINES_SOLD_PUMPS = '/machines/sold_pumps'
...
MACHINES_CREATE_SOLD_PUMP = '/machines/sold_pumps/create'
MACHINE_DETAILS = '/machines/details/{id}'
MACHINE_SOLD_DETAILS = '/machines/sold/details/{id}'
MACHINE_SERVICE_REPORTS = '/machines/{id}/service-reports'
MACHINE_DELETE = '/machines/{id}/delete'
MACHINE_DELETE_SOLD_PUMPS = '/machines/sold_pumps/{id}/delete'
